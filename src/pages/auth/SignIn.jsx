...
import AuthCard, { LogoMark } from '../../components/AuthCard'
...
export default function SignIn() {
  ...
  return (
    <AuthCard>
      ...
      <p className="text-gray-500 text-sm text-center mb-6">Please enter your details to sign into intelimerch</p>
      ...
      <div className="space-y-4">
        ...
        <button onClick={() => navigate('/dashboard')} className="btn-primary">Sign In</button>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button className="border border-gray-200 rounded-xl py-2.5 flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 transition-all">
            <GoogleIcon />Google
          </button>
          <button className="border border-gray-200 rounded-xl py-2.5 flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 transition-all">
            <AppleIcon />Apple
